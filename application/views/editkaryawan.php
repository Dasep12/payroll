                        ...
                        <form id="addKaryawan" method="post" class="form-horizontal">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" value="<?= $data->nama ?>" id="nama" name="nama" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" disabled="" value="<?= $data->nik ?>" name="nik" id="nik" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?= $data->email ?>" name="email" id="email" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text" value="<?= $data->tgl_lahir ?>" name="tanggal" autocomplete="off" id="tanggal" class="form-control" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select id="jobclass" name="jobclass" class="form-control show-tick">
                                                <option selected=""><?= $data->jobclass ?></option>
